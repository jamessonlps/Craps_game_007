...
print('Você começará esse jogo com 30 fichas, mas tente sair daqui com pelo menos o dobro delas, mas cuidado para não sair sem nada...')
...
print('')
print('Deixe deu feedback quanto à nossa organização e estrutura :)')
print('Comentários:')
comentarios = input()                                    